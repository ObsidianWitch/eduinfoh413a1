...
\lstset{
	...
	emph={IterativeImprovement, Permutation, Neighbourhood, TransposeNeighbourhood, ExchangeNeighbourhood,
	      InsertNeighbourhood, RulesFactory, VariableNeighbourhoodDescent, Matrix},
...
\bibitem{cite:slsBook} \emph{Stochastic Local Search Foundations and Applications}, Holger H. Hoos \& Thomas Stützle

\bibitem{cite:lopPaper} \emph{The Linear Ordering Problem: Instances, Search Space Analysis and Algorithms}, Tommaso Schiavinotto \& Thomas Stützle
\end{thebibliography}
